    ...
    public class SchoolInterceptorLogging : DbCommandInterceptor
    {
        ...
        public override void ScalarExecuted(
            ...
            else
            {
                _logger.TraceApi(
                    "SQL Database",
                    "SchoolInterceptor.ScalarExecuted", _stopwatch.Elapsed,
        ...
        public override void NonQueryExecuted(
            ...
            else
            {
                _logger.TraceApi(
                    "SQL Database",
                    "SchoolInterceptor.NonQueryExecuted", _stopwatch.Elapsed,
                    "Command: {0}: ", command.CommandText
                );
            }
        ...
        public override void ReaderExecuted(
            ...
            else
            {
                _logger.TraceApi(
                    "SQL Database",
                    "SchoolInterceptor.ReaderExecuted", _stopwatch.Elapsed,
                    "Command: {0}: ", command.CommandText
                );
            }
